...
import addonEventsHandler from "./addonEventsHandler";
...
let viewsDir = process.cwd() + "/dist/views";
...
const staticDir = process.cwd() + "/dist/build";
